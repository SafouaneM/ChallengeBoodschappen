...
foreach($_SESSION['boodschappen'] as $b) {
    echo "<li><a href='formulier.php?verwijder=$b'>$b</a></li>";
}
echo "</ul>";
?>
...
<a href="formulier.php?leegmaken=ja">Laat boodschappen verdwijnen</a>; /*Dit is de knop om alle boodschappen te verwijderen*/
